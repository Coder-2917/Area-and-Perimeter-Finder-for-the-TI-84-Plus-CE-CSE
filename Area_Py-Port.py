...
if x == 2:
    ...
    print(f"The Area of this Rectangle is {rectangle_area(s1, s2)}, and it's Perimeter is {rectangle_perimeter(s1, s2)}.")
...
if x == 5:
    ...
    print(f"The Area of this Trapezoid is {trapezoid_area(b1, b2, h)}, and it's Perimeter is {trapezoid_perimeter(b1, b2, c, d)}.")
